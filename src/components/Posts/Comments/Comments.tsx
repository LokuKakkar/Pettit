...
import { Box, Text, Flex, SkeletonCircle, SkeletonText, Stack } from '@chakra-ui/react';
...
const Comments:React.FC<CommentsProps> = ({user, selectedPost, communityId}) => {
    ...
    return (
        <Box bg="#1a282d" borderRadius="0px 0px 4px 4px" p={2} >
            <Flex direction="column" pl={10} pr={4} mb={10} fontSize="10pt" width="100%" >
            ...
            <Stack spacing={6} p={2}>
                ...
                {fetchLoading ? (
                    <>
                        {[0,1,2].map((item) => (
                            <Box key={item} padding="6" bg="#1a282d">
